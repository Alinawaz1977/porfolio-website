    ...
    return (
        <div id={id} className='overflow-hidden min-h-screen  w-screen flex flex-col justify-center  items-center bg-[#313849]' >
            ...
            <div className='flex flex-wrap flex-col mx-5 md:mx-0 md:flex-row gap-5' >
                <div onClick={() => navigate('https://significoagency.vercel.app/')} className="project w-[90vw] group relative mx-auto h-[25vh] md:w-[30vw] md:h-[30vh] text-white rounded-md overflow-hidden">
                    <img
                    ...
                    <div
                        ...
                        "
                    >
                        <h1 className="text-center text-2xl">Agency website</h1>
                        <h1 className="text-center">I had clone the agencywebsite significo.com</h1>
