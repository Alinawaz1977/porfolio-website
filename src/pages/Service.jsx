...
const Service = ({ id }) => {
    ...
    return (
        <div id={id} className=' overflow-hidden min-h-screen w-screen flex flex-col justify-center items-center bg-[#151925]' >
            <h1 className='text-3xl serviceHeading text-white md:text-[4vw] font-bold text-center py-10' >Our <span className='text-center text-[#00d8ff]' >Services</span></h1>
            <div className='flex flex-col mx-5 md:mx-0 md:flex-row gap-5' >
                <div className='serviceBox w-full md:w-[30vw] text-white rounded-md bg-[#313849] p-5 ' >
                ...
                <div className='w-full serviceBox md:w-[30vw] text-white rounded-md bg-[#313849] p-5 ' >
                    <svg className='mx-auto' width="120" height="60" viewBox="0 0 120 60" xmlns="http://www.w3.org/2000/svg">
                        <rect
                            x="18"
                            y="12"
